...
const sai = {
  location: "Raleigh, NC",
  code: [TypeScript, JavaScript, Java, Go, Python],
  tools: [React, Angular, Node, Spring, Docker, Kubernetes, Terraform, Databricks, Azure],
  architecture: ["microservices", "distributed systems", "platform engineering", "open source"],
  currently: {
                 work: "Full Stack, AI/ML @ Optum",
                 writing: "s11a.com",
                 brewing: "practical LLM and agent workflows"
               },
  studied: "BSE Electrical and Computer Engineering, Biomedical Engineering — Duke"
}
```

<img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="60" align="absmiddle" hspace="8">&nbsp;&nbsp;<em><b>I love connecting over a coffee - say hi, or hit me up on Discord @funsaized :)</b></em>
